"""HVAB hover collective 6 deg — far-field D40, collective-sweep member.

Physics identical to the 10-deg case-1 twin (pure ALM, isotropic Gaussian,
N=64, corrections OFF, NASA OVERFLOW deck) except collective_deg=6.
...
config = build_config(
    collective_deg=6.0, mtip=0.65, preset="farfield40",
    eps_correction=None,
    prandtl_loss=False,
    ...
    run_tag="farfield40_eso_c6_mpi2",
)
