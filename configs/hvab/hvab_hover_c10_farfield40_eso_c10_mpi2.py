"""HVAB hover collective 10 deg — far-field D40, collective-sweep member.

Physics identical to the 10-deg case-1 twin (pure ALM, isotropic Gaussian,
N=64, corrections OFF, NASA OVERFLOW deck) except collective_deg=10.
...
config = build_config(
    ...
    run_tag="farfield40_eso_c10_mpi2",
)
