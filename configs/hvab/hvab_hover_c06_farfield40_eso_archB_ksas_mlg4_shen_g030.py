"""HVAB hover c6.0 M0.65 — archB + Shen g=0.3 mlg4 (workshop collective sweep).
...
4-GPU run: driver run_hvab_archb_collective_sweep.sh, or
    mpirun --mca pml ucx -x LBM_ESOTERIC=1 -n 4 python main_mpi.py \
        --config configs/hvab/hvab_hover_c06_farfield40_eso_archB_ksas_mlg4_shen_g030.py \
        --steps 31425 --log-every 64 --cuda-aware 1 --dist-init \
        --devices 0,1,2,3 --vtk-every 1257 --vtk-fields-last 5 \
        --ckpt-every 31425 --csv archB_mlg4_shen_g030_c06.csv
"""
import os, sys
...
config = build_config(
    collective_deg=6.0, mtip=0.65, preset="farfield40_mlg4",
