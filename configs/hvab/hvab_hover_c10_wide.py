"""HVAB hover 10° — fine-region margin 진단 A/B (wide, preset=light_wide).
...
→ CP/FM 붕괴의 주범 = fine-region 과소(격자) 확정.
    python main.py --config configs/hvab/hvab_hover_c10_wide.py
"""
import os, sys
sys.path.insert(0, os.path.dirname(__file__))
from _hvab_hover_base import build_config
config = build_config(collective_deg=10.0, mtip=0.65, preset="light_wide",
