"""
CLF5605 Airfoil — 2D D2Q9 Cumulant + 4-level MLG, α=+0°, IBB wall

IBB variant of the α=0 MLG case. Pair with the HWBB sibling
`airfoil_clf5605_Re20k_M06_a00_hwbb.py` to compare Bouzidi
...
Usage:
    python main.py --config configs/airfoil_clf5605_Re20k_M06_a00_ibb.py
"""
...
CPC_FINEST = CPC_L0 * (REFINE ** (NUM_LEVELS - 1))  # = 512 for 4 levels
...
# MLG region containment: each finer level must lie inside its parent.
