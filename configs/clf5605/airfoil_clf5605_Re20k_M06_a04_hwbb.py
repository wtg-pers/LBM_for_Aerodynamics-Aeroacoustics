"""
CLF5605 Airfoil — 2D D2Q9 Cumulant + 4-level MLG, α=+4°, HWBB wall

HWBB baseline variant of the α=4 MLG case. Pair with the IBB sibling
`airfoil_clf5605_Re20k_M06_a04_ibb.py` to compare half-way
bounce-back vs. Bouzidi interpolated bounce-back. Output directories
carry a `_ibb` / `_hwbb` suffix so both runs coexist on disk.

Usage:
    python main.py --config configs/airfoil_clf5605_Re20k_M06_a04_hwbb.py
"""
