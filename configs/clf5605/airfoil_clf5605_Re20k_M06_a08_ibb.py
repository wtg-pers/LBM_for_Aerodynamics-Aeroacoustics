"""
CLF5605 Airfoil — 2D D2Q9 Cumulant + 4-level MLG, α=+8°, IBB wall

IBB variant of the α=8 MLG case. Pair with the HWBB sibling
`airfoil_clf5605_Re20k_M06_a08_hwbb.py` to compare Bouzidi
...
Usage:
    python main.py --config configs/airfoil_clf5605_Re20k_M06_a08_ibb.py
"""
