"""SGS regression test config — Smagorinsky on, Cs=0.18, Re=40."""
...
print(f"  Nx={Nx}, Ny={Ny}, SGS=smagorinsky Cs=0.18")
...
time = {"max_steps": 5000, "output_interval": 1000,
