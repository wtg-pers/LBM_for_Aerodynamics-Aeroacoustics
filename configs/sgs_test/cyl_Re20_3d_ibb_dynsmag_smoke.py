"""Tiny 3D Re=20 cylinder smoke test for IBB-3D + Dynamic Smagorinsky.

Same domain as cyl_Re20_3d_ibb_smoke.py. Verifies dyn_smag dispatch path
(macro + dyn_smag pre-pass + cumulant collide WALE branch) end-to-end.
"""
...
print(f"  [smoke 3D IBB+DynSmag Re={RE}, D={D_LU}] Nx={Nx} Ny={Ny} Nz={Nz}, tau={TAU:.4f}")
...
_folder = "result_3d_ibb_dynsmag_smoke"
output = {
