"""NACA0012 3D thin slab (Nz=4) a=10 — Re 1e6, STANDARD path, SGS off.
...
c=100, Nz=4.
    ...
    python main.py --config configs/stl/naca0012_a10_nz4_re1e6.py \
...
_spec = importlib.util.spec_from_file_location("naca_lad_1e6", _base)
...
_folder = "results_naca0012_a10_nz4_re1e6"
config["output"] = dict(
    config["output"],
