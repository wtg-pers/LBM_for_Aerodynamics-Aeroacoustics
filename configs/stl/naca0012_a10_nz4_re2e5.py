"""NACA0012 3D thin slab (Nz=4) a=10 — Re 2e5, STANDARD path, SGS off.
...
c=100, Nz=4.
    ...
    python main.py --config configs/stl/naca0012_a10_nz4_re2e5.py \
...
_spec = importlib.util.spec_from_file_location("naca_lad_2e5", _base)
...
_folder = "results_naca0012_a10_nz4_re2e5"
config["output"] = dict(
    config["output"],
