"""LE-resolution ladder point c=141 (patch 79) — thin-span (nz4 lineage).
...
Run (ONE GPU each; two points can run in parallel on two cards):
    LBM_ESOTERIC=1 python main.py \
        --config configs/stl/naca0012_a10_surfel_re1e6_nz4_c141.py --gpu 0
"""
...
config = _m._build(141, wall_bc="surfel", nz_frac=0.04)
...
_folder = "results_naca0012_a10_surfel_re1e6_nz4_c141"
config["output"] = dict(
    config["output"],
