"""span16 + trip, wall-law sampling height h_law = 2 (patch 71 h-sweep).
...
Run (cluster, ONE node, --mca pml ucx REQUIRED, 64 sec. 19c):
    LBM_ESOTERIC=1 mpirun --mca pml ucx -n 2 python main.py --mpi \\
        --config configs/stl/naca0012_a10_surfel_re1e6_span16_trip_h2.py \\
...
_folder = "results_naca0012_a10_surfel_re1e6_span16_trip_h2"
