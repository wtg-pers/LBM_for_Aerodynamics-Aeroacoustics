"""APC 18x8E hover @ 3460 RPM — ALM mlg4, tip-loss OFF.
...
Run (메인 디렉토리 기준):
    LBM_ESOTERIC=1 python main.py --mpi \\
        --config configs/apc18x8e/apc18x8e_hover_3460rpm_notl.py \\
        --gpu 2 --steps 31425 --log-every 64 --vtk-every 35 \\
        --vtk-fields-last 180 --ckpt-every 31425 --csv apc18x8e_3460_notl.csv
"""
import os, sys
sys.path.insert(0, os.path.dirname(__file__))
from _apc18x8e_hover_base import build_config

config = build_config(rpm=3460, tip_loss="off")
