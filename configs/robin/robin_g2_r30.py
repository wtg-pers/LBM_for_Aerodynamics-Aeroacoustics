"""ROBIN rotor-off grid ladder — 2-level, r = 30 (patch robin/13, 1-knob = r).
...
Run (main dir):
    LBM_ESOTERIC=1 python main.py --config configs/robin/robin_g2_r30.py --gpu 0
"""
...
config = _m.build(r_lu0=30, tag="robin_g2_r30", max_steps=8400,
                  output_interval=420, num_levels=2)

if __name__ == "__main__":
    _m.report(config, "robin_g2_r30")
