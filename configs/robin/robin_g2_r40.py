"""ROBIN rotor-off grid ladder — 2-level, r = 40 (patch robin/13, 1-knob = r).
...
Run (main dir):
    LBM_ESOTERIC=1 python main.py --config configs/robin/robin_g2_r40.py --gpu 0
"""
...
config = _m.build(r_lu0=40, tag="robin_g2_r40", max_steps=11200,
                  output_interval=560, num_levels=2)

if __name__ == "__main__":
    _m.report(config, "robin_g2_r40")
