"""ROBIN rotor-off grid ladder — 2-level, r = 20 (patch robin/13, 1-knob = r).
...
Run (main dir):
    LBM_ESOTERIC=1 python main.py --config configs/robin/robin_g2_r20.py --gpu 0
"""
...
config = _m.build(r_lu0=20, tag="robin_g2_r20", max_steps=5600,
                  output_interval=280, num_levels=2)

if __name__ == "__main__":
    _m.report(config, "robin_g2_r20")
