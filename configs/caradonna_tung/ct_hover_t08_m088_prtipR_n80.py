...
표준 Prandtl(R_tip_eff=R), no taper, **n_radial=80** (baseline prtipR는 40).
...
config["actuator_line"]["rotor"]["grid"]["n_radial"] = 80
_base = config["output"]["output_dir"].rsplit("/vtk",1)[0] + "_prtipR_n80"
