"""
APC 9x4.5MR Propeller -- Axial Flight J=0.129, Cumulant + ALM + MLG (4-Level)
...
Usage:
    python main.py --config configs/alm/alm_9x45e_J0129_mlg4_test.py

NOTE: Step 1 positive-CT isolation test, 4-level variant. Pairs with
alm_9x45e_J0608_mlg4_test.py for sign-convention regression check at lower
memory cost than the mlg5 baseline. J=0.129 lies well inside the propeller
(thrust-producing) operating regime; UIUC measurement gives CT > 0.
"""
