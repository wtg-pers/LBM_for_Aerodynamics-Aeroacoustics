"""
2D Cylinder Re=500, Henderson 60D×40D — IBB + padded MLG-3 (auto-gen)
...
print(f"  [cyl Re=500, D_fine={CPC_FINEST}, padded MLG-3 IBB]")
...
_folder = f"result_cyl_Re500_ibb_mlg3"
output = {
