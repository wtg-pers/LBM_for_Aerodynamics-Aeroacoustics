"""
3D Cylinder Re=3900, v2 domain — IBB wall + Smagorinsky SGS.

Comparison-set member 2 of 3:
    (1) v2_ibb:         IBB + no-SGS    -> wall BC contribution alone
    (2) THIS:           IBB + Smag      -> combined effect
    (3) v2_hwbb_smag:   HWBB + Smag     -> SGS contribution alone

Output folder: result_cyl_Re3900_v2_ibb_smag/.
"""
...
# --- Output folder ----------------------------------------------------
_folder = "result_cyl_Re3900_v2_ibb_smag"
config["output"] = {
...
print("  >> [comparison] IBB on, SGS=Smagorinsky Cs=0.17")
