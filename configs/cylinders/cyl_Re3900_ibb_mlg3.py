"""
2D Cylinder Re=1000, Henderson 60D×40D — IBB + padded MLG-3 (auto-gen)
...
print(f"  [cyl Re=1000, D_fine={CPC_FINEST}, padded MLG-3 IBB]")
...
mlg = {
    "enabled": True, "num_levels": NUM_LEVELS, "overlap_width": 3,
    "interpolation": "cubic", "filter_level": 2,
    "levels": [
        {},
...
time = {"max_steps": 500000, "output_interval": 1000,
...
_folder = f"result_cyl_Re3900_ibb_mlg3"
output = {
